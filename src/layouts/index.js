...
import imgIcons from '../assets/icon-footer.png';
    ...
    <div className={styles.normal}>
      <nav>
        ...
        <ul className={styles.nav}>
          {navs.map((nav, index) => (
            <li key={index} className={ location.pathname === nav.to ? styles.active : ''}>
